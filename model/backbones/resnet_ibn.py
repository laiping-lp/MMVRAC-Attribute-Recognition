...
model_urls = {
    ...
    'resnet50_ibn_a': '/home/liyuke/data4/checkpoint/resnet50_ibn_a-d9d0bb7b.pth',
    'resnet101_ibn_a': '/home/liyuke/data4/checkpoint/resnet101_ibn_a-59ea0ac6.pth',
    ...
    'resnet50_ibn_b': '/home/liyuke/data4/checkpoint/resnet50_ibn_b-9ca61e85.pth',
    'resnet101_ibn_b': '/home/liyuke/data4/checkpoint/resnet101_ibn_b-c55f6dba.pth',
}
...
def resnet101_ibn_a(pretrained=False, **kwargs):
    ...
    model = ResNet_IBN(block=Bottleneck_IBN,
                       ...
                       **kwargs)
    if pretrained:
        model.load_state_dict(torch.load(model_urls['resnet101_ibn_a']), strict=False)
    return model
