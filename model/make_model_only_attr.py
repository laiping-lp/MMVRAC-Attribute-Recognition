...
from model.backbones.vit_pytorch_attr_only import only_attr_vit_base_patch16_224_TransReID,only_attr_vit_large_patch16_224_TransReID
import torch
...
def make_model(cfg, modelname, num_class, num_class_domain_wise=None):
    if modelname == 'vit':
        ...
        print('===========building attr_vit===========')
    elif modelname == "only_attr_vit_cls":
        model = build_only_attr_vit_cls(num_class, cfg, __factory_T_type)
        print('===========building only_attr_vit_cls===========')
    else:
